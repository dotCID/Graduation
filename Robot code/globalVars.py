...
THRESHOLD_EDIFF             = 0.5     # Energy difference in movement needed for BPM adjustment
...
BPM_DIFF                    = 15.0     # Maximum BPM shift if user input was detected

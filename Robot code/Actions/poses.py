...
## For playing dead
pos_dead       = (120.0,   5.0, 100.0)

## Action 1: Contact
contact_joint_positions = [ 94.0 , 50.0, 85.0 ]

## Action 2: Scan
scan_pos_L = [  0.0,  65.0, 100.0]
scan_pos_R = [120.0,  50.0,  90.0]
...
## Action 4: Stevie
drifting_pos_C = [ 110.0,  50.0, 90.0]
drifting_pos_L = [ 120.0,  70.0, 100.0]
drifting_pos_R = [  95.0,  60.0, 80.0]

## Action 5: Bored
bored_pos_C = [  85.0, 70.0, 100.0]
bored_pos_L = [  25.0, 70.0, 100.0]
bored_pos_R = [ 120.0,  70.0, 100.0]
